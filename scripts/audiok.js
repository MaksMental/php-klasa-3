...
var j = new Audio("jakie_usugik.mp3");
j.loop = false;
j.autoplay = false;
...
var h = new Audio("liczba_coacherowk.mp3");
h.loop = false;
h.autoplay = false;
...
var g = new Audio("opinia_dt_prack.mp3");
g.loop = false;
g.autoplay = false;
...
var f = new Audio("skypek.mp3");
f.loop = false;
f.autoplay = false;


document.getElementById("stop6").onclick = function () {
    f.pause();
};

document.getElementById("play6").onclick = function () {
    f.play();
};


var s = new Audio("terminyk.mp3");
s.loop = false;
s.autoplay = false;
...
document.getElementById("play7").onclick = function () {
    s.play();
};

var a = new Audio("wykrzstalceniek.mp3");
a.loop = false;
a.autoplay = false;


document.getElementById("stop8").onclick = function () {
    a.pause();
};

document.getElementById("play8").onclick = function () {
    a.play();
};
